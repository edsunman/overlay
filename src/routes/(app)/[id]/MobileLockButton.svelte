...
<div class="relative w-full h-12 lg:hidden block  {!$eventStore.edit_mode ? 'text-neutral-700 hover:text-neutral-400' : 'text-neutral-800'}">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"  viewBox="0 0 24 24" stroke-width="1.5" 
                class=" pointer-events-none absolute w-6 h-6 top-0 bottom-0 right-0 left-0 m-auto">
            ...
            <input class=" border-2 appearance-none rounded-xl w-full h-12 cursor-pointer
